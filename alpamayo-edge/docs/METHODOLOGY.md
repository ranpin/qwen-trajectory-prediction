...
| **lm_head** | 4096×151936 | 0.622 B | 8.2% | **1.245 GB** | **25.6%** | **22.0%** | **默认未量化（AWQ 跳过输出层）；已另建 INT4 版**：引擎 4.847→3.923 GB、TPOT 30.73→25.69 ms（**+19.6%**，事前预测 +19%），代价 n=210 −1.4 pts。第 9 次尝试才成（校准 batch 16→1，见 PROBLEMS G3） | §1.5 框、PROBLEMS G3 |
