...
> **当前处置（2026-07-21）**：#1 功耗、#5 sweep、#4 多模态**已完成**（见上）。#2 FP16 基线、#3 掉点评测、#7 VLA 轨道、#6 运维收尾均经用户决策**暂缓**——非遗漏，待日后再启。#2/#3 与 Kaggle 凭据轮换绑定。

已跑通"链路 + 双量化延迟/吞吐/显存/功耗/能效/sweep/多模态"。要让评测更完整，后续可选：
